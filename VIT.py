...
# capa de enlace residual
class ResidualAdd(nn.Module):
    """
    Una conexión residual seguida de una norma de capa.
    Tenga en cuenta que para simplificar el código, la norma es primero en lugar de último.
    """
...
# Capa Feedforward Totalmente Conectada
