...
def main():
    ...
    train_loss, valid_loss, train_epochs_loss, valid_epochs_loss = train(model, train_loader, valid_loader,args.epoches, lossF, optimizer, device,scheduler, args.saveround)

    path = "E:\IA\FinalFinal\VIT_DogCat\With lightning\data"
    test_loader = load_data_test(path)
